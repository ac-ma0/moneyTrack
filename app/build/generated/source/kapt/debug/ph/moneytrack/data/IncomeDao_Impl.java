...
public final class IncomeDao_Impl implements IncomeDao {
  ...
  public IncomeDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfIncome = new EntityInsertionAdapter<Income>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `income` (`id`,`userId`,`title`,`amount`,`occurredOn`,`category`,`notes`,`updatedAt`,`deleted`) VALUES (?,?,?,?,?,?,?,?,?)";
      }
      ...
      public List<Income> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _tmpDeleted = _tmp != 0;
            _item = new Income(_tmpId,_tmpUserId,_tmpTitle,_tmpAmount,_tmpOccurredOn,_tmpCategory,_tmpNotes,_tmpUpdatedAt,_tmpDeleted);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<Income>> observeAll() {
    final String _sql = "SELECT * FROM income WHERE deleted=0 ORDER BY occurredOn DESC";
  ...
  @Override
  public Object get(final String id, final String userId, final Continuation<? super Income> p2) {
    final String _sql = "SELECT * FROM income WHERE id=? AND userId=? LIMIT 1";
      ...
      public Income call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfDeleted);
            _tmpDeleted = _tmp != 0;
            _result = new Income(_tmpId,_tmpUserId,_tmpTitle,_tmpAmount,_tmpOccurredOn,_tmpCategory,_tmpNotes,_tmpUpdatedAt,_tmpDeleted);
          } else {
            _result = null;
          }
          return _result;
