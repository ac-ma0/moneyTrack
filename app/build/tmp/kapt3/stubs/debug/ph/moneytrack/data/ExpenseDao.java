...
public abstract interface ExpenseDao {
    ...
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM expenses WHERE deleted=0 ORDER BY occurredOn DESC")
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<ph.moneytrack.data.Expense>> observeAll();
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "SELECT * FROM expenses WHERE id=:id AND userId=:userId LIMIT 1")
    public abstract java.lang.Object get(@org.jetbrains.annotations.NotNull()
    java.lang.String id, @org.jetbrains.annotations.NotNull()
    java.lang.String userId, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super ph.moneytrack.data.Expense> p2);
